...
@interface bidirectional_scrollObject : KrollCoverageObject {
#else
@interface bidirectional_scrollObject : KrollObject {
#endif
@private
...
extern NSString * bidirectional_scroll$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	bidirectional_scrollObject *_bidirectional_scroll;
	BOOL shutdown;
