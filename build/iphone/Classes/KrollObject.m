 ...
 * Copyright (c) 2009-2011 by bidirectional_scroll, Inc. All Rights Reserved.
...
//@interface bidirectional_scrollObject : NSObject
//@end

@interface bidirectional_scrollObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[bidirectional_scrollObject class]])
		{
			for (NSString *key in [[(bidirectional_scrollObject*)o modules] allKeys])
			{
