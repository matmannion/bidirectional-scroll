...
// in simulator we redefine to format for bidirectional_scroll Developer console
...
{\
	NSString * exceptionName = [@"org.bidirectional_scroll." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.bidirectional_scroll";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIbidirectional_scrollNativeItemNone = -1, 
	UIbidirectional_scrollNativeItemSpinner = -2,
	UIbidirectional_scrollNativeItemProgressBar = -3,
	
	UIbidirectional_scrollNativeItemSlider = -4,
	UIbidirectional_scrollNativeItemSwitch = -5,
	UIbidirectional_scrollNativeItemMultiButton = -6,
	UIbidirectional_scrollNativeItemSegmented = -7,
	
	UIbidirectional_scrollNativeItemTextView = -8,
	UIbidirectional_scrollNativeItemTextField = -9,
	UIbidirectional_scrollNativeItemSearchBar = -10,
	
	UIbidirectional_scrollNativeItemPicker = -11,
	UIbidirectional_scrollNativeItemDatePicker = -12,
	
	UIbidirectional_scrollNativeItemInfoLight = -13,
	UIbidirectional_scrollNativeItemInfoDark = -14,
	
	UIbidirectional_scrollNativeItemDisclosure = -15,
	
	UIbidirectional_scrollNativeItemContactAdd = -16
};
