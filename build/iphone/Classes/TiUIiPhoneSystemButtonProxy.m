...
MAKE_SYSTEM_PROP(ACTIVITY,UIbidirectional_scrollNativeItemSpinner);
MAKE_SYSTEM_PROP(SPINNER,UIbidirectional_scrollNativeItemSpinner);
MAKE_SYSTEM_PROP(INFO_LIGHT,UIbidirectional_scrollNativeItemInfoLight);
MAKE_SYSTEM_PROP(INFO_DARK,UIbidirectional_scrollNativeItemInfoDark);
MAKE_SYSTEM_PROP(DISCLOSURE,UIbidirectional_scrollNativeItemDisclosure);
MAKE_SYSTEM_PROP(CONTACT_ADD,UIbidirectional_scrollNativeItemContactAdd);
