...
static NSString * const kbidirectional_scrollJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_bidirectional_scrollInjection
{
	...
	[html appendString:kbidirectional_scrollJavascript];
...
{
	// attempt to make well-formed HTML and inject in our bidirectional_scroll bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _bidirectional_scrollInjection]];
	...
	else
	{
		...
		if ([[NSFileManager defaultManager] fileExistsAtPath:path])
		{
			...
			else
			{
				...
				{
					NSLog(@"[WARN] I have no idea what the appropriate text encoding is for: %@. Please report this to bidirectional_scroll support.",url);
				}
			}
